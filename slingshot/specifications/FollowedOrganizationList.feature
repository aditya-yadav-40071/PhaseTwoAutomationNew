...
Scenario: To verify that onclick of org name should navigate to org profile page from Followed Organization page with correct org name with DATA SearchOrg_Success
	Given I am ON dashboard page
	When I CLICK leftMenuButton
    And I CLICK followedOrganization link
	Then I am ON followedOrganizationList page 
	When I VERIFY organizationsDisplayed 
	And I CLICK firstOrganization name
	Then I am ON viewOrganizationProfile page
