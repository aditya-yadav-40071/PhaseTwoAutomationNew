...
Scenario: To verify the result displayed for search pods is correct with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	And I ENTER searchInputs for search with DATA SearchRecommendedPods_Success
	Then I CLICK searchPodArrow 
	And I VERIFY correctPodsDisplayed
	Then the correct search pod result is displayed


Scenario: To verify that clicking on pods navigate to pod details page with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	And I CLICK searchPodArrow
...
Scenario: To verify the name of pod after navigating to pod details page with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	And I ENTER searchInputs for search with DATA SearchRecommendedPods_Success
...
Scenario: To verify the number of pods displayed in each page is matching with the number shown with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	When I VERIFY podsDisplayed
...
Scenario: To wishlist a pod and verify the pod is displaying in the wishlist page with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	When I VERIFY podsDisplayed
...
Scenario: To remove a wishlist and verify that the wishlist has been removed with DATA SearchRecommendedPods_Success
	Given I am ON dashboard page
	And I CLICK viewAllRecommendedPods
	Then I am ON recommendedPods page
	When I VERIFY podsDisplayed
