...
Scenario: To edit the Basic Information of a user and verify the same is displayed on View Profile page with DATA SubAdminBaisicInfo_Success 	
	Given I am ON dashboard page
	When I CLICK userEditProfile link
	Then I am ON editProfile page
	And I ENTER basicInformation valid details with DATA SubAdminBaisicInfo_Success
